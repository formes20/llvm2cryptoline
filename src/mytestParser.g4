...
options { tokenVocab = mytestLexer; language=Cpp;}
...
aexp :  VAR						# a_var		
        ...
        | INST_ADD aexp aexp 				# add_aexp // add x1 x2
        | INST_SUB aexp aexp				# sub_aexp
        | INST_MUL aexp aexp				# mul_aexp
        | INST_SQ aexp					# sq_aexp
...
aexp_extend:      aexp					# extend_aexp 
		...
		;
         //|VARS var_expansion;
//var_expansion: VAR OROP INT DOTDOT INT ;

//a_op : ADDOP | SUBOP | MULOP ;
...
rbexp_atom : TRUE					# r_true
             ...
             ;
//cmpop : ULTOP | ULEOP | UGTOP | UGEOP | SLTOP | SLEOP | SGTOP | SGEOP | EQOP;
...
//r_op : ADDOP | SUBOP | MULOP | ANDOP | EQOP  ;
...
//operations : ADDOP | SUBOP | MULOP | POWOP ;
