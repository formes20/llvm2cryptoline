/*
Parsing CryptoLine file:		[OK]		0.001425 seconds
Checking well-formedness:		[OK]		0.000438 seconds
Transforming to SSA form:		[OK]		0.000166 seconds
Normalizing specification:		[OK]		0.000091 seconds
Rewriting assignments:			[OK]		0.000063 seconds
Verifying program safety:		
	 Cut 0
	     Round 1 (41 safety conditions, timeout = 300 seconds)
	 ...
	 Overall			[OK]		30.638310 seconds
Verifying range assertions:		[OK]		21.978263 seconds
Verifying range specification:		[OK]		31.731257 seconds
Rewriting value-preserved casting:	[OK]		0.000021 seconds
Verifying algebraic assertions:		[OK]		0.000674 seconds
Verifying algebraic specification:	[OK]		0.047961 seconds
Verification result:			[OK]		84.399475 seconds
...
(*modify*)
split v_add_h32 tmp v_add 32;
assert true && eq v_shr*(2**25)@64 v_shl+v_add_h32*(2**32)@64;
assume eq v_shr*(2**25) v_shl+v_add_h32*(2**32) && true;
...
(*modify*)
split v_add30_h32 tmp v_add30 32;
assert true && eq v_shr31*(2**25)@64 v_shl33+v_add30_h32*(2**32)@64;
assume eq v_shr31*(2**25) v_shl33+v_add30_h32*(2**32) && true;
...
(*modify*)
split v_add35_h32 tmp v_add35 32;
assert true && eq v_shr36*(2**25)@64 v_shl38+v_add35_h32*(2**32)@64;
assume eq v_shr36*(2**25) v_shl38+v_add35_h32*(2**32) && true;
...
(*modify*)
split v_add40_h32 tmp v_add40 32;
assert true && eq v_shr41*(2**25)@64 v_shl43+v_add40_h32*(2**32)@64;
assume eq v_shr41*(2**25) v_shl43+v_add40_h32*(2**32) && true;
...
(*modify*)
split v_add45_h32 tmp v_add45 32;
assert true && eq v_shr46*(2**25)@64 v_shl48+v_add45_h32*(2**32)@64;
assume eq v_shr46*(2**25) v_shl48+v_add45_h32*(2**32) && true;
...
(*modify*)
split v_add50_h32 tmp v_add50 32;
assert true && eq v10 *(2**26)@64 v_shl53+v_add50_h32*(2**32)@64;
assume eq v10 *(2**26) v_shl53+v_add50_h32*(2**32) && true;
...
(*modify*)
split v_add55_h32 tmp v_add55 32;
assert true && eq v11 *(2**26)@64 v_shl58+v_add55_h32*(2**32)@64;
assume eq v11 *(2**26) v_shl58+v_add55_h32*(2**32) && true;
...
(*modify*)
split v_add60_h32 tmp v_add60 32;
assert true && eq v12 *(2**26)@64 v_shl63+v_add60_h32*(2**32)@64;
assume eq v12 *(2**26) v_shl63+v_add60_h32*(2**32) && true;
...
(*modify*)
split v_add65_h32 tmp v_add65 32;
assert true && eq v13 *(2**26)@64 v_shl68+v_add65_h32*(2**32)@64;
assume eq v13 *(2**26) v_shl68+v_add65_h32*(2**32) && true;
...
(*modify*)
split v_add70_h32 tmp v_add70 32;
assert true && eq v14 *(2**26)@64 v_shl73+v_add70_h32*(2**32)@64;
assume eq v14 *(2**26) v_shl73+v_add70_h32*(2**32) && true;
...
(*modify*)
cast [tmp10] v_conv75@sint32 v_sub54@sint64;
assert true && eq (sext tmp10 31) v_add50_h32;
assume eq tmp10 v_add50_h32 && true ;
...
(*modify*)
cast [tmp2] v_conv77@sint32 v_add52@sint64;
assert true && eq (sext tmp2 31) v_add30_h32;
assume eq tmp2 v_add30_h32 && true ;
...
(*modify*)
cast [tmp4] v_conv79@sint32 v_sub59@sint64;
assert true && eq (sext tmp4 31) v_add55_h32;
assume eq tmp4 v_add55_h32 && true ;
...
(*modify*)
cast [tmp3] v_conv81@sint32 v_add57@sint64;
assert true && eq (sext tmp3 31) v_add35_h32;
assume eq tmp3 v_add35_h32 && true ;
...
(*modify*)
cast [tmp5] v_conv83@sint32 v_sub64@sint64;
assert true && eq (sext tmp5 31) v_add60_h32;
assume eq tmp5 v_add60_h32 && true ;
...
(*modify*)
cast [tmp6] v_conv85@sint32 v_add62@sint64;
assert true && eq (sext tmp6 31) v_add40_h32;
assume eq tmp6 v_add40_h32 && true ;
...
(*modify*)
cast [tmp7] v_conv87@sint32 v_sub69@sint64;
assert true && eq (sext tmp7 31) v_add65_h32;
assume eq tmp7 v_add65_h32 && true ;
...
(*modify*)
cast [tmp8] v_conv89@sint32 v_add67@sint64;
assert true && eq (sext tmp8 31) v_add45_h32;
assume eq tmp8 v_add45_h32 && true ;
...
(*modify*)
cast [tmp9] v_conv91@sint32 v_sub74@sint64;
assert true && eq (sext tmp9 31) v_add70_h32;
assume eq tmp9 v_add70_h32 && true ;
...
(*modify*)
cast [tmp1] v_conv93@sint32 v_add72@sint64;
assert true && eq (sext tmp1 31) v_add_h32;
assume eq tmp1 v_add_h32 && true ;
