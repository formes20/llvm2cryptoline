...
Parsing CryptoLine file:		[OK]		0.000617 seconds
Checking well-formedness:		[OK]		0.000193 seconds
Transforming to SSA form:		[OK]		0.000116 seconds
...
Verifying program safety:		
	 ...
	 Overall			[OK]		3.641159 seconds
Verifying range assertions:		[OK]		0.583298 seconds
Verifying range specification:		[OK]		1.508119 seconds
Rewriting value-preserved casting:	[OK]		0.000085 seconds
Verifying algebraic assertions:		[OK]		0.000789 seconds
Verifying algebraic specification:	[OK]		0.040687 seconds
Verification result:			[OK]		5.775749 seconds
...
(* Heuristics applied. *)
assert true && eq tmp_v_conv_high1 0@128;
assume eq tmp_v_conv_high1 0 && true;
...
(* Heuristics applied. *)
assert true && eq tmp_v_mul28227_high1 0@128;
assume eq tmp_v_mul28227_high1 0 && true;
...
(* Heuristics applied. *)
assert true && eq tmp_v_mul42228_high1 0@128;
assume eq tmp_v_mul42228_high1 0 && true;
...
(* Heuristics applied. *)
assert true && eq tmp_v_conv14_high1 0@128;
assume eq tmp_v_conv14_high1 0 && true;
...
(*modify*)
assert true && eq tmp_v_add145_high64 0@128;
assume eq tmp_v_add145_high64 0 && true;
