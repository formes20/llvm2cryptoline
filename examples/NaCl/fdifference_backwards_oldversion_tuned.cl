proc main (uint64 iin_0, uint64 iin_8, uint64 iin_16, uint64 iin_24, uint64 iin_32, uint64 ioutput_0, uint64 ioutput_8, uint64 ioutput_16, uint64 ioutput_24, uint64 ioutput_32) =
{
	...
	&&
	and[
		iin_0	<u	(2**51+2**15)@64,
	iin_8	<u	(2**51+2**15)@64,
	iin_16	<u	(2**51+2**15)@64,
	iin_24	<u	(2**51+2**15)@64,
	iin_32	<u	(2**51+2**15)@64,
	ioutput_0	<u	(2**51+2**15)@64,
	ioutput_8	<u	(2**51+2**15)@64,
	ioutput_16	<u	(2**51+2**15)@64,
	ioutput_24	<u	(2**51+2**15)@64,
	ioutput_32	<u	(2**51+2**15)@64]
}
...
cmov v_and61 v_sub55_flag (1)@sint64 (0)@sint64;
(* Rule AND after LSHR Heuristics applied. *)
...
cmov v_and69 v_sub63_flag (1)@sint64 (0)@sint64;
(* Rule AND after LSHR Heuristics applied. *)
...
cmov v_and77 v_sub71_flag (1)@sint64 (0)@sint64;
(* Rule AND after LSHR Heuristics applied. *)
...
cmov v_and85 v_sub79_flag (1)@sint64 (0)@sint64;
(* Rule AND after LSHR Heuristics applied. *)
...
vpc ioutput_32_prime@uint64 ioutput_32@sint64;
...

{
	...
	&&
	and[
		ioutput_0_prime	<u	(2**51+2**15)@64,
	ioutput_8_prime	<u	(2**51+2**15)@64,
	ioutput_16_prime	<u	(2**51+2**15)@64,
	ioutput_24_prime	<u	(2**51+2**15)@64
	//ioutput_32_prime	<u	(2**51+2**15)@64
	]
}
