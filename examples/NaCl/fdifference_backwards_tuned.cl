/*
===== Verification =====
Arguments: -v -isafety -debug -disable_safety

Parsing CryptoLine file:		[OK]		0.001275 seconds
Checking well-formedness:		[OK]		0.000359 seconds
Transforming to SSA form:		[OK]		0.000188 seconds
Normalizing specification:		[OK]		0.000126 seconds
Rewriting assignments:			[OK]		0.000101 seconds
Verifying range assertions:		[OK]		0.148484 seconds
Verifying range specification:		[OK]		0.900954 seconds
Rewriting value-preserved casting:	[OK]		0.000053 seconds
Verifying algebraic assertions:		[OK]		0.000513 seconds
Verifying algebraic specification:	[OK]		0.041838 seconds
Verification result:			[OK]		1.094360 seconds
...
(*modify*)
vpc iin_0@sint64 iin_0;
vpc iin_8@sint64 iin_8;
vpc iin_16@sint64 iin_16;
vpc iin_24@sint64 iin_24;
vpc iin_32@sint64 iin_32;
vpc ioutput_0@sint64 ioutput_0;
vpc ioutput_8@sint64 ioutput_8;
vpc ioutput_16@sint64 ioutput_16;
vpc ioutput_24@sint64 ioutput_24;
vpc ioutput_32@sint64 ioutput_32;
...
and sint64 v_and v_shr (0x8000000000000)@uint64;
(*   %add = add nsw i64 %and, %sub *)
add v_add v_and v_sub;
(*   %and21 = and i64 %shr, 1 *)
(* You may need to modify here *)
//and uint64 v_and21 v_shr (0x1)@uint64;
and sint64 v_and21 v_shr (0x1)@uint64;
(*modify*)
assert true && eq v_and v_and21*(2**51)@64;
assume eq v_and v_and21*(2**51) && true;
...
and sint64 v_and26 v_shr25 (0x8000000000000)@uint64;
(*   %add28 = add nsw i64 %and26, %sub23 *)
add v_add28 v_and26 v_sub23;
(*   %and29 = and i64 %shr25, 1 *)
(* You may need to modify here *)
//and uint64 v_and29 v_shr25 (0x1)@uint64;
and sint64 v_and29 v_shr25 (0x1)@uint64;
(*modify*)
assert true && eq v_and26 v_and29*(2**51)@64;
assume eq v_and26 v_and29*(2**51) && true;
...
and sint64 v_and34 v_shr33 (0x8000000000000)@uint64;
(*   %add36 = add nsw i64 %and34, %sub31 *)
add v_add36 v_and34 v_sub31;
(*   %and37 = and i64 %shr33, 1 *)
(* You may need to modify here *)
//and uint64 v_and37 v_shr33 (0x1)@uint64;
and sint64 v_and37 v_shr33 (0x1)@uint64;
(*modify*)
assert true && eq v_and34 v_and37*(2**51)@64;
assume eq v_and34 v_and37*(2**51) && true;
...
and sint64 v_and42 v_shr41 (0x8000000000000)@uint64;
(*   %add44 = add nsw i64 %and42, %sub39 *)
add v_add44 v_and42 v_sub39;
(*   %and45 = and i64 %shr41, 1 *)
(* You may need to modify here *)
//and uint64 v_and45 v_shr41 (0x1)@uint64;
and sint64 v_and45 v_shr41 (0x1)@uint64;
(*modify*)
assert true && eq v_and42 v_and45*(2**51)@64;
assume eq v_and42 v_and45*(2**51) && true;
(*   %10 = add i64 %9, %and45 *)
add v10 v9 v_and45;
(*   %sub47 = sub i64 %8, %10 *)
sub v_sub47 v8 v10;
...
cmov v_and50 v_shr49 (0x8000000000000)@sint64 0@sint64;
...
and sint64 v_and58 v_shr57 (0x8000000000000)@uint64;
...
and sint64 v_and61 v_shr57 (0x1)@uint64;
(*modify*)
assert true && eq v_and58 v_and61*(2**51)@64;
assume eq v_and58 v_and61*(2**51) && true;
...
and sint64 v_and66 v_shr65 (0x8000000000000)@uint64;
...
and sint64 v_and69 v_shr65 (0x1)@uint64;
(*modify*)
assert true && eq v_and66 v_and69*(2**51)@64;
assume eq v_and66 v_and69*(2**51) && true;
...
and sint64 v_and74 v_shr73 (0x8000000000000)@uint64;
...
and sint64 v_and77 v_shr73 (0x1)@uint64;
(*modify*)
assert true && eq v_and74 v_and77*(2**51)@64;
assume eq v_and74 v_and77*(2**51) && true;
...
and sint64 v_and82 v_shr81 (0x8000000000000)@uint64;
...
and sint64 v_and85 v_shr81 (0x1)@uint64;
(*modify*)
assert true && eq v_and82 v_and85*(2**51)@64;
assume eq v_and82 v_and85*(2**51) && true;
...
*/
(*modify*)
vpc ioutput_0_prime@uint64 ioutput_0@sint64;
vpc ioutput_8_prime@uint64 ioutput_8@sint64;
vpc ioutput_16_prime@uint64 ioutput_16@sint64;
vpc ioutput_24_prime@uint64 ioutput_24@sint64;
vpc ioutput_32_prime@uint64 ioutput_32@sint64;(fail at safety check)
