...
split v_shr tmp_to_be_used v5 16;
(*   %add14 = add i128 %shr, %4 *)
add v_add14 v_shr v4;
(*   %and = shl i128 %5, 40 *)
//shl v_and v5 40;
(*modify*)
split tmp_H1 v_and_star v5 40;
mul v_and v_and_star (2**40)@uint128;
(*   %shl = and i128 %and, 72056494526300160 *)
(* You may need to modify here *)
and uint128 v_shl v_and (0xFFFF0000000000)@uint128;
(*modify*)
assert true && eq v_shl  tmp_to_be_used * (2**40)@128;
assume eq v_shl  tmp_to_be_used * (2**40) && true;
...
(* You may need to modify here *)
split v_shr21 tmp_to_be_used v6 16;
(*   %add23 = add i128 %add17, %shr21 *)
add v_add23 v_add17 v_shr21;
(*   %and25 = shl i128 %6, 40 *)
//shl v_and25 v6 40;
(*modify*)
split tmp_H1 v_and25_star v6 40;
mul v_and25 v_and25_star (2**40)@uint128;
(*   %shl26 = and i128 %and25, 72056494526300160 *)
(* You may need to modify here *)
and uint128 v_shl26 v_and25 (0xFFFF0000000000)@uint128;
(*modify*)
assert true && eq v_shl26 tmp_to_be_used * (2**40)@128;
assume eq v_shl26 tmp_to_be_used * (2**40) && true;
...
(* You may need to modify here *)
split v_shr33 tmp_to_be_used v_add14 16;
(*   %add35 = add i128 %add28, %shr33 *)
add v_add35 v_add28 v_shr33;
(*   %and37 = shl i128 %add14, 40 *)
//shl v_and37 v_add14 40;
(*modify*)
split tmp_H1 v_and37_star v_add14 40;
mul v_and37 v_and37_star (2**40)@uint128;
(*   %shl38 = and i128 %and37, 72056494526300160 *)
(* You may need to modify here *)
and uint128 v_shl38 v_and37 (0xFFFF0000000000)@uint128;
(*modify*)
assert true && eq v_shl38 tmp_to_be_used * (2**40)@128;
assume eq v_shl38 tmp_to_be_used * (2**40) && true;
(*   %add40 = add i128 %sub31, %shl38 *)
add v_add40 v_sub31 v_shl38;
(*   %shr45 = lshr i128 %add35, 56 *)
(* You may need to modify here *)
split v_shr45 tmp_to_be_used v_add35 56;
...
(*modify no heristic?*)
assert true && eq v_and49 tmp_to_be_used;
assume eq v_and49 tmp_to_be_used  && true;
(*   %shr51 = lshr i128 %add47, 56 *)
(* You may need to modify here *)
split v_shr51 tmp_to_be_used v_add47 56;
(*   %and54 = and i128 %add47, 72057594037927935 *)
(* You may need to modify here *)
and uint128 v_and54 v_add47 (0xFFFFFFFFFFFFFF)@uint128;
(*modify no heristic?*)
assert true && eq v_and54 tmp_to_be_used;
assume eq v_and54 tmp_to_be_used  && true;
(*   %shr56 = lshr i128 %add47, 72 *)
(* You may need to modify here *)
split v_shr56 tmp_to_be_used v_add47 72;
(*   %add58 = add nuw nsw i128 %shr56, %and49 *)
add v_add58 v_shr56 v_and49;
(*   %and60 = shl nuw nsw i128 %shr51, 40 *)
shl v_and60 v_shr51 40;
(*   %shl61 = and i128 %and60, 72056494526300160 *)
(* You may need to modify here *)
and uint128 v_shl61 v_and60 (0xFFFF0000000000)@uint128;
(*modify*)
assert true && eq v_shr51 * (2**40)@128 (v_shl61 + v_shr56 * (2**56)@128);
assume eq v_shr51 * (2**40) (v_shl61 + v_shr56 * (2**56) )&& true;
...
(* You may need to modify here *)
(*modify*)
(*split v_shr68 tmp_to_be_used v_sub66 56;*)
split v_shr68 tmp_0 v_sub66 56;
...
(* You may need to modify here *)
(*modify*)
(*split v_shr75 tmp_to_be_used v_add70 56;*)
split v_shr75 tmp_1 v_add70 56;
...
split tmp_v9_0 v10_0 v9_0 64;
(*modify*)
(* vpc v10_0@uint64 v9_0@uint128; *)
vpc v10_0@uint64 v10_0@uint128;
split tmp_v9_1 v10_1 v9_1 64;
(*modify*)
(* vpc v10_1@uint64 v9_1@uint128; *)
...
(*modify*)
assert true && eq v11_0 tmp_0;
assume eq v11_0 tmp_0 && true;
assert true && eq v11_1 tmp_1;
assume eq v11_1 tmp_1 && true;
...
assert true && eq v_conv88 tmp_to_be_used;
assume eq v_conv88 tmp_to_be_used && true;
...
split tmp_v_add85 v_conv91 v_add85 64;
vpc v_conv91@uint64 v_conv91@uint128;
(*modify*)
assert true && eq tmp_v_add85 0@128;
assume eq tmp_v_add85 0 && true;
...
{
	eqmod
	(limbs  56  [in_0,in_16,in_32,in_48,in_64,in_80,in_96])
