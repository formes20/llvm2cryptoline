...
===== Verification =====
 ...
 Parsing CryptoLine file:		[OK]		0.001111 seconds
Checking well-formedness:		[OK]		0.000319 seconds
...
Verifying program safety:		
	 Cut 0
	     Round 1 (55 safety conditions, timeout = 300 seconds)
	 ...
	 Overall			[OK]		19.869298 seconds
Verifying range assertions:		[OK]		0.620636 seconds
Verifying range specification:		[OK]		0.900309 seconds
Rewriting value-preserved casting:	[OK]		0.000070 seconds
Verifying algebraic assertions:		[OK]		0.000909 seconds
Verifying algebraic specification:	[OK]		0.038814 seconds
Verification result:			[OK]		21.432757 seconds
...
(* Heuristics applied. *)
assert true && eq v_shl26_i tmp_v_add85_i_low16 * (2**40)@128;
assume eq v_shl26_i tmp_v_add85_i_low16 * (2**40) && true;
...
split tmp_v10_high64_0 v11_0 v10_0 64;
vpc v11_0@uint64 v11_0@uint128;
split tmp_v10_high64_1 v11_1 v10_1 64;
...
(* Heuristics applied. *)
assert true && eq uext v12_0 64 tmp_v_sub66_i_low56;
assume eq v12_0 tmp_v_sub66_i_low56 && true;
and uint64 v12_1 v11_1 (0xFFFFFFFFFFFFFF)@uint64;
(* Heuristics applied. *)
assert true && eq uext v12_1 64 tmp_v_add70_i_low56;
assume eq v12_1 tmp_v_add70_i_low56 && true;
...
split tmp_v_add77_i_high64 v14 v_add77_i 64;
...
split tmp_v_add85_i3_high64 v_conv91_i v_add85_i3 64;
vpc v_conv91_i@uint64 v_conv91_i@uint128;
(*modify*)
assert true && eq tmp_v_add85_i3_high64 0@128;
assume eq tmp_v_add85_i3_high64 0 && true;
