...
Parsing CryptoLine file:		[OK]		0.001781 seconds
Checking well-formedness:		[OK]		0.000675 seconds
Transforming to SSA form:		[OK]		0.000607 seconds
Normalizing specification:		[OK]		0.000143 seconds
Rewriting assignments:			[OK]		0.000125 seconds
Verifying program safety:		
	 Cut 0
	     Round 1 (93 safety conditions, timeout = 300 seconds)
	 ...
	 Overall			[OK]		21.490406 seconds
Verifying range assertions:		[OK]		0.187413 seconds
Verifying range specification:		[OK]		0.000543 seconds
Rewriting value-preserved casting:	[OK]		0.000016 seconds
Verifying algebraic assertions:		[OK]		0.000568 seconds
Verifying algebraic specification:	[OK]		0.047999 seconds
Verification result:			[OK]		21.731383 seconds
...
split tmp_v5_high2 v_mul15_i357_star v5 62;
shl v_mul15_i357 v_mul15_i357_star 2;
(* Heuristics applied. *)
assert true && eq tmp_v5_high2 0@64;
assume eq tmp_v5_high2 0 && true;
(*   %mul18.i360 = shl i64 %6, 2 *)
split tmp_v6_high2 v_mul18_i360_star v6 62;
shl v_mul18_i360 v_mul18_i360_star 2;
(* Heuristics applied. *)
assert true && eq tmp_v6_high2 0@64;
assume eq tmp_v6_high2 0 && true;
(*   %mul21.i363 = shl i64 %7, 2 *)
split tmp_v7_high2 v_mul21_i363_star v7 62;
shl v_mul21_i363 v_mul21_i363_star 2;
(* Heuristics applied. *)
assert true && eq tmp_v7_high2 0@64;
assume eq tmp_v7_high2 0 && true;
(*   %mul24.i366 = shl i64 %8, 2 *)
split tmp_v8_high2 v_mul24_i366_star v8 62;
shl v_mul24_i366 v_mul24_i366_star 2;
(* Heuristics applied. *)
assert true && eq tmp_v8_high2 0@64;
assume eq tmp_v8_high2 0 && true;
...

{
	...
	(limbs  58  [in_0_init, in_8_init, in_16_init, in_24_init, in_32_init, in_40_init, in_48_init, in_56_init, in_64_init]  **  2)
	((2  **  521)  -  1)
	&&
	true
}
