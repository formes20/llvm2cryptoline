...
Parsing CryptoLine file:		[OK]		0.002480 seconds
Checking well-formedness:		[OK]		0.000968 seconds
Transforming to SSA form:		[OK]		0.000251 seconds
Normalizing specification:		[OK]		0.000264 seconds
Rewriting assignments:			[OK]		0.000170 seconds
Verifying program safety:		
	 ...
	 Overall			[OK]		1.599953 seconds
Verifying range assertions:		[OK]		0.773616 seconds
Verifying range specification:		[OK]		0.180914 seconds
Rewriting value-preserved casting:	[OK]		0.000190 seconds
Verifying algebraic assertions:		[OK]		0.001008 seconds
Verifying algebraic specification:	[OK]		0.037335 seconds
Verification result:			[OK]		2.597934 seconds
...
split tmp_v0_high64 v_conv v0 64;
...
split tmp_v1_high64 v_conv3 v1 64;
...
split tmp_v2_high64 v_conv7 v2 64;
...
split tmp_v3_high64 v_conv11 v3 64;
...
split tmp_v4_high64 v_conv15 v4 64;
...
split tmp_v5_high64 v_conv19 v5 64;
...
split tmp_v6_high64 v_conv23 v6 64;
...
split tmp_v7_high64 v_conv27 v7 64;
...
split tmp_v8_high64 v_conv31 v8 64;
...
(* You may need to modify here *)
split v_shr tmp_v_conv_low58 v_conv 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv_low58 v_and;
assume eq tmp_v_conv_low58 v_and && true;
(*   %sh.diff = lshr i128 %0, 58 *)
(* You may need to modify here *)
split v_sh_diff tmp_v0_low58 v0 58;
(* Heuristics applied. *)
assert true && eq tmp_v0_low58 uext v_and 64;
assume eq tmp_v0_low58 v_and && true;
(*   %tr.sh.diff = trunc i128 %sh.diff to i64 *)
split tmp_v_sh_diff_high64 v_tr_sh_diff v_sh_diff 64;
...
(* You may need to modify here *)
split v_sum_shift tmp_v0_low116 v0 116;
(*   %shr46276 = trunc i128 %sum.shift to i64 *)
split tmp_v_sum_shift_high64 v_shr46276 v_sum_shift 64;
vpc v_shr46276@uint64 v_shr46276@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift_high64 0@128;
assume eq tmp_v_sum_shift_high64 0 && true;
(*modify*)
shr v_shl_star v_shl 6;
vpc tmp_v0_high64@uint64 tmp_v0_high64@uint128;
assert true && eq tmp_v0_high64  v_shr46276*(2**52)@64 + v_shl_star;
assume eq tmp_v0_high64  v_shr46276*(2**52) + v_shl_star && true;
(*   %shr51 = lshr i64 %conv3, 58 *)
(* You may need to modify here *)
split v_shr51 tmp_v_conv3_low58 v_conv3 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv3_low58 v_and4;
assume eq tmp_v_conv3_low58 v_and4 && true;
(*   %sh.diff277 = lshr i128 %1, 58 *)
(* You may need to modify here *)
split v_sh_diff277 tmp_v1_low58 v1 58;
(* Heuristics applied. *)
assert true && eq tmp_v1_low58 uext v_and4 64;
assume eq tmp_v1_low58 v_and4 && true;
(*   %tr.sh.diff278 = trunc i128 %sh.diff277 to i64 *)
split tmp_v_sh_diff277_high64 v_tr_sh_diff278 v_sh_diff277 64;
...
(* You may need to modify here *)
split v_sum_shift279 tmp_v1_low116 v1 116;
(*   %shr64280 = trunc i128 %sum.shift279 to i64 *)
split tmp_v_sum_shift279_high64 v_shr64280 v_sum_shift279 64;
vpc v_shr64280@uint64 v_shr64280@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift279_high64 0@128;
assume eq tmp_v_sum_shift279_high64 0 && true;
(*modify*)
shr v_shl58_star v_shl58 6;
vpc tmp_v1_high64@uint64 tmp_v1_high64@uint128;
assert true && eq tmp_v1_high64  v_shr64280*(2**52)@64 + v_shl58_star;
assume eq tmp_v1_high64  v_shr64280*(2**52) + v_shl58_star && true;
(*   %shr69 = lshr i64 %conv7, 58 *)
(* You may need to modify here *)
split v_shr69 tmp_v_conv7_low58 v_conv7 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv7_low58 v_and8;
assume eq tmp_v_conv7_low58 v_and8 && true;
(*   %sh.diff281 = lshr i128 %2, 58 *)
(* You may need to modify here *)
split v_sh_diff281 tmp_v2_low58 v2 58;
(* Heuristics applied. *)
assert true && eq tmp_v2_low58 uext v_and8 64;
assume eq tmp_v2_low58 v_and8 && true;
(*   %tr.sh.diff282 = trunc i128 %sh.diff281 to i64 *)
split tmp_v_sh_diff281_high64 v_tr_sh_diff282 v_sh_diff281 64;
...
(* You may need to modify here *)
split v_sum_shift283 tmp_v2_low116 v2 116;
(*   %shr82284 = trunc i128 %sum.shift283 to i64 *)
split tmp_v_sum_shift283_high64 v_shr82284 v_sum_shift283 64;
vpc v_shr82284@uint64 v_shr82284@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift283_high64 0@128;
assume eq tmp_v_sum_shift283_high64 0 && true;
(*modify*)
shr v_shl76_star v_shl76 6;
vpc tmp_v2_high64@uint64 tmp_v2_high64@uint128;
assert true && eq tmp_v2_high64  v_shr82284*(2**52)@64 + v_shl76_star;
assume eq tmp_v2_high64  v_shr82284*(2**52) + v_shl76_star && true;
(*   %shr87 = lshr i64 %conv11, 58 *)
(* You may need to modify here *)
split v_shr87 tmp_v_conv11_low58 v_conv11 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv11_low58 v_and12;
assume eq tmp_v_conv11_low58 v_and12 && true;
(*   %sh.diff285 = lshr i128 %3, 58 *)
(* You may need to modify here *)
split v_sh_diff285 tmp_v3_low58 v3 58;
(* Heuristics applied. *)
assert true && eq tmp_v3_low58 uext v_and12 64;
assume eq tmp_v3_low58 v_and12 && true;
(*   %tr.sh.diff286 = trunc i128 %sh.diff285 to i64 *)
split tmp_v_sh_diff285_high64 v_tr_sh_diff286 v_sh_diff285 64;
...
(* You may need to modify here *)
split v_sum_shift287 tmp_v3_low116 v3 116;
(*   %shr100288 = trunc i128 %sum.shift287 to i64 *)
split tmp_v_sum_shift287_high64 v_shr100288 v_sum_shift287 64;
vpc v_shr100288@uint64 v_shr100288@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift287_high64 0@128;
assume eq tmp_v_sum_shift287_high64 0 && true;
(*modify*)
shr v_shl94_star v_shl94 6;
vpc tmp_v3_high64@uint64 tmp_v3_high64@uint128;
assert true && eq tmp_v3_high64  v_shr100288*(2**52)@64 + v_shl94_star;
assume eq tmp_v3_high64  v_shr100288*(2**52) + v_shl94_star && true;
(*   %shr105 = lshr i64 %conv15, 58 *)
(* You may need to modify here *)
split v_shr105 tmp_v_conv15_low58 v_conv15 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv15_low58 v_and16;
assume eq tmp_v_conv15_low58 v_and16 && true;
(*   %sh.diff289 = lshr i128 %4, 58 *)
(* You may need to modify here *)
split v_sh_diff289 tmp_v4_low58 v4 58;
(* Heuristics applied. *)
assert true && eq tmp_v4_low58 uext v_and16 64;
assume eq tmp_v4_low58 v_and16 && true;
(*   %tr.sh.diff290 = trunc i128 %sh.diff289 to i64 *)
split tmp_v_sh_diff289_high64 v_tr_sh_diff290 v_sh_diff289 64;
...
(* You may need to modify here *)
split v_sum_shift291 tmp_v4_low116 v4 116;
(*   %shr118292 = trunc i128 %sum.shift291 to i64 *)
split tmp_v_sum_shift291_high64 v_shr118292 v_sum_shift291 64;
vpc v_shr118292@uint64 v_shr118292@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift291_high64 0@128;
assume eq tmp_v_sum_shift291_high64 0 && true;
(*modify*)
shr v_shl112_star v_shl112 6;
vpc tmp_v4_high64@uint64 tmp_v4_high64@uint128;
assert true && eq tmp_v4_high64  v_shr118292*(2**52)@64 + v_shl112_star;
assume eq tmp_v4_high64  v_shr118292*(2**52) + v_shl112_star && true;
(*   %shr123 = lshr i64 %conv19, 58 *)
(* You may need to modify here *)
split v_shr123 tmp_v_conv19_low58 v_conv19 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv19_low58 v_and20;
assume eq tmp_v_conv19_low58 v_and20 && true;
(*   %sh.diff293 = lshr i128 %5, 58 *)
(* You may need to modify here *)
split v_sh_diff293 tmp_v5_low58 v5 58;
(* Heuristics applied. *)
assert true && eq tmp_v5_low58 uext v_and20 64;
assume eq tmp_v5_low58 v_and20 && true;
(*   %tr.sh.diff294 = trunc i128 %sh.diff293 to i64 *)
split tmp_v_sh_diff293_high64 v_tr_sh_diff294 v_sh_diff293 64;
...
(* You may need to modify here *)
split v_sum_shift295 tmp_v5_low116 v5 116;
(*   %shr136296 = trunc i128 %sum.shift295 to i64 *)
split tmp_v_sum_shift295_high64 v_shr136296 v_sum_shift295 64;
vpc v_shr136296@uint64 v_shr136296@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift295_high64 0@128;
assume eq tmp_v_sum_shift295_high64 0 && true;
(*modify*)
shr v_shl130_star v_shl130 6;
vpc tmp_v5_high64@uint64 tmp_v5_high64@uint128;
assert true && eq tmp_v5_high64  v_shr136296*(2**52)@64 + v_shl130_star;
assume eq tmp_v5_high64  v_shr136296*(2**52) + v_shl130_star && true;
(*   %shr141 = lshr i64 %conv23, 58 *)
(* You may need to modify here *)
split v_shr141 tmp_v_conv23_low58 v_conv23 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv23_low58 v_and24;
assume eq tmp_v_conv23_low58 v_and24 && true;
(*   %sh.diff297 = lshr i128 %6, 58 *)
(* You may need to modify here *)
split v_sh_diff297 tmp_v6_low58 v6 58;
(* Heuristics applied. *)
assert true && eq tmp_v6_low58 uext v_and24 64;
assume eq tmp_v6_low58 v_and24 && true;
(*   %tr.sh.diff298 = trunc i128 %sh.diff297 to i64 *)
split tmp_v_sh_diff297_high64 v_tr_sh_diff298 v_sh_diff297 64;
...
(* You may need to modify here *)
split v_sum_shift299 tmp_v6_low116 v6 116;
(*   %shr154300 = trunc i128 %sum.shift299 to i64 *)
split tmp_v_sum_shift299_high64 v_shr154300 v_sum_shift299 64;
vpc v_shr154300@uint64 v_shr154300@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift299_high64 0@128;
assume eq tmp_v_sum_shift299_high64 0 && true;
(*modify*)
shr v_shl148_star v_shl148 6;
vpc tmp_v6_high64@uint64 tmp_v6_high64@uint128;
assert true && eq tmp_v6_high64  v_shr154300*(2**52)@64 + v_shl148_star;
assume eq tmp_v6_high64  v_shr154300*(2**52) + v_shl148_star && true;
(*   %shr159 = lshr i64 %conv27, 58 *)
(* You may need to modify here *)
split v_shr159 tmp_v_conv27_low58 v_conv27 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv27_low58 v_and28;
assume eq tmp_v_conv27_low58 v_and28 && true;
(*   %sh.diff301 = lshr i128 %7, 58 *)
(* You may need to modify here *)
split v_sh_diff301 tmp_v7_low58 v7 58;
(* Heuristics applied. *)
assert true && eq tmp_v7_low58 uext v_and28 64;
assume eq tmp_v7_low58 v_and28 && true;
(*   %tr.sh.diff302 = trunc i128 %sh.diff301 to i64 *)
split tmp_v_sh_diff301_high64 v_tr_sh_diff302 v_sh_diff301 64;
...
(* You may need to modify here *)
split v_sum_shift303 tmp_v7_low116 v7 116;
(*   %shr172304 = trunc i128 %sum.shift303 to i64 *)
split tmp_v_sum_shift303_high64 v_shr172304 v_sum_shift303 64;
vpc v_shr172304@uint64 v_shr172304@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_sum_shift303_high64 0@128;
assume eq tmp_v_sum_shift303_high64 0 && true;
(*modify*)
shr v_shl166_star v_shl166 6;
vpc tmp_v7_high64@uint64 tmp_v7_high64@uint128;
assert true && eq tmp_v7_high64  v_shr172304*(2**52)@64 + v_shl166_star;
assume eq tmp_v7_high64  v_shr172304*(2**52) + v_shl166_star && true;
(*   %shr175 = lshr i64 %conv31, 58 *)
(* You may need to modify here *)
split v_shr175 tmp_v_conv31_low58 v_conv31 58;
(* Heuristics applied. *)
assert true && eq tmp_v_conv31_low58 v_and32;
assume eq tmp_v_conv31_low58 v_and32 && true;
(*modify*)
...
(* You may need to modify here *)
split v_shr178 tmp_v8_low64 v8 64;
(* Heuristics applied. *)
assert true && eq tmp_v8_low64 uext v_conv31 64;
assume eq tmp_v8_low64 v_conv31 && true;
(* Heuristics applied. *)
assert true && eq v_shr178 tmp_v8_high64;
assume eq v_shr178 tmp_v8_high64 && true;
(*   %conv179 = trunc i128 %shr178 to i64 *)
split tmp_v_shr178_high64 v_conv179 v_shr178 64;
vpc v_conv179@uint64 v_conv179@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_shr178_high64 0@128;
assume eq tmp_v_shr178_high64 0 && true;
(*   %and180 = shl i64 %conv179, 6 *)
split tmp_v_conv179_high6 v_and180_star v_conv179 58;
shl v_and180 v_and180_star 6;
...
split tmp_v_add182_high1 v_shl187_star v_add182 63;
shl v_shl187 v_shl187_star 1;
(*modify*)
assert true && eq tmp_v_add182_high1 0@64;
assume eq tmp_v_add182_high1 0 && true;
(*   %9 = lshr i64 %conv179, 51 *)
(* You may need to modify here *)
split v9 tmp_v_conv179_low51 v_conv179 51;
(*   %shl188 = and i64 %9, 8190 *)
(* You may need to modify here *)
and uint64 v_shl188 v9 (0x1FFE)@uint64;
(*modify*)
assert true && eq (v_shl188 - (tmp_v_conv179_high6 * (2**7)@64)) * (2**57)@64 + v_shl181  (v_and180_star) * (2**6)@64;
assume eq (v_shl188 - (tmp_v_conv179_high6 * (2**7))) * (2**57) + v_shl181  (v_and180_star) * (2**6) && true;
...
(* You may need to modify here *)
split v_shr194 tmp_v_add190_low58 v_add190 58;
...
(* Heuristics applied. *)
assert true && eq v_and198 tmp_v_add190_low58;
assume eq v_and198 tmp_v_add190_low58 && true;
