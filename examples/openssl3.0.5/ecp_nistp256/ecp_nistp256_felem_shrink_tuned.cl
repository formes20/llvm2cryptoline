...
Parsing CryptoLine file:		[OK]		0.000933 seconds
Checking well-formedness:		[OK]		0.000247 seconds
...
Verifying program safety:		
	 Cut 0
	     Round 1 (29 safety conditions, timeout = 300 seconds)
	 ...
	 Overall			[OK]		0.637040 seconds
Verifying range assertions:		[OK]		0.648463 seconds
Verifying range specification:		[OK]		0.000905 seconds
Rewriting value-preserved casting:	[OK]		0.000730 seconds
Verifying algebraic assertions:		[OK]		0.001010 seconds
Verifying algebraic specification:	[OK]		0.041624 seconds
Verification result:			[OK]		1.332039 seconds
...
split v_shr tmp_v1_low64 v1 64;
...
(* Heuristics applied. *)
assert true && eq v_conv7 tmp_v1_low64;
assume eq v_conv7 tmp_v1_low64 && true;
...
(* You may need to modify here *)
split v_shr17 tmp_v_add3_low64 v_add3 64;
(*   %conv18 = trunc i128 %shr17 to i64 *)
split tmp_v_shr17_high64 v_conv18 v_shr17 64;
vpc v_conv18@uint64 v_conv18@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_shr17_high64 0@128;
assume eq tmp_v_shr17_high64 0 && true;
(*   %conv21 = and i128 %add3, 18446744073709551615 *)
(* You may need to modify here *)
and uint128 v_conv21 v_add3 (0xFFFFFFFFFFFFFFFF)@uint128;
(* Heuristics applied. *)
assert true && eq v_conv21 tmp_v_add3_low64;
assume eq v_conv21 tmp_v_add3_low64 && true;
(*   %sub = sub nsw i128 %conv21, %shr17 *)
//sub v_sub v_conv21 v_shr17;
subb b v_sub v_conv21 v_shr17;
(*   %shl = shl nuw nsw i128 %shr17, 32 *)
split tmp_v_shr17_high32 v_shl_star v_shr17 96;
shl v_shl v_shl_star 32;
(* Heuristics applied. *)
assert true && eq tmp_v_shr17_high32 0@128;
assume eq tmp_v_shr17_high32 0 && true;
...
(* You may need to modify here *)
split v_shr29 tmp_v_add27_low64 v_add27 64;
(*   %conv30 = trunc i128 %shr29 to i64 *)
split tmp_v_shr29_high64 v_conv30 v_shr29 64;
vpc v_conv30@uint64 v_conv30@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_shr29_high64 0@128;
assume eq tmp_v_shr29_high64 0 && true;
...
(* Heuristics applied. *)
assert true && eq v_conv34 tmp_v_add27_low64;
assume eq v_conv34 tmp_v_add27_low64 && true;
(*   %sub38 = sub nsw i128 %conv34, %shr29 *)
//sub v_sub38 v_conv34 v_shr29;
subb b v_sub38 v_conv34 v_shr29;
(*   %shl40 = shl nuw nsw i128 %shr29, 32 *)
split tmp_v_shr29_high32 v_shl40_star v_shr29 96;
shl v_shl40 v_shl40_star 32;
(* Heuristics applied. *)
assert true && eq tmp_v_shr29_high32 0@128;
assume eq tmp_v_shr29_high32 0 && true;
(*   %add42 = add nsw i128 %sub38, %shl40 *)
//add v_add42 v_sub38 v_shl40;
...
(* You may need to modify here *)
split v_shr51 tmp_v_add42_low64 v_add42 64;
(*   %conv52 = trunc i128 %shr51 to i64 *)
split tmp_v_shr51_high64 v_conv52 v_shr51 64;
vpc v_conv52@uint64 v_conv52@uint128;
(* Heuristics applied. *)
assert true && eq tmp_v_shr51_high64 0@128;
assume eq tmp_v_shr51_high64 0 && true;
(*   %sub53 = sub i64 0, %conv52 *)
//sub v_sub53 (0)@uint64 v_conv52;
subb h v_sub53 (0)@uint64 v_conv52;
(*   %conv55 = trunc i128 %add42 to i64 *)
split tmp_v_add42_high64 v_conv55 v_add42 64;
vpc v_conv55@uint64 v_conv55@uint128;
(* Heuristics applied. *)
assert true && eq uext v_conv55 64 tmp_v_add42_low64;
assume eq v_conv55 tmp_v_add42_low64 && true;
(* Heuristics applied. *)
assert true && eq tmp_v_add42_high64 uext v_conv52 64;
assume eq tmp_v_add42_high64 v_conv52 && true;
(*   %shr56.neg = ashr i64 %conv55, 63 *)
(* You may need to modify here *)
//split v_shr56_neg tmp_v_conv55_low63 v_conv55 63;
...
(* You may need to modify here *)
split v_shr75 tmp_v_sub65_low64 v_sub65 64;
(*   %add79 = add i128 %sub69, %shr75 *)
add v_add79 v_sub69 v_shr75;
(*   %conv81 = trunc i128 %sub65 to i64 *)
split tmp_v_sub65_high64 v_conv81 v_sub65 64;
vpc v_conv81@uint64 v_conv81@uint128;
(* Heuristics applied. *)
assert true && eq uext v_conv81 64 tmp_v_sub65_low64;
assume eq v_conv81 tmp_v_sub65_low64 && true;
(* Heuristics applied. *)
assert true && eq tmp_v_sub65_high64 v_shr75;
assume eq tmp_v_sub65_high64 v_shr75 && true;
(*   %shr85 = lshr i128 %add79, 64 *)
(* You may need to modify here *)
split v_shr85 tmp_v_add79_low64 v_add79 64;
(*   %add89 = add nuw nsw i128 %add8, %shr85 *)
add v_add89 v_add8 v_shr85;
(*   %conv91 = trunc i128 %add79 to i64 *)
split tmp_v_add79_high64 v_conv91 v_add79 64;
vpc v_conv91@uint64 v_conv91@uint128;
(* Heuristics applied. *)
assert true && eq uext v_conv91 64 tmp_v_add79_low64;
assume eq v_conv91 tmp_v_add79_low64 && true;
(* Heuristics applied. *)
assert true && eq tmp_v_add79_high64 v_shr85;
assume eq tmp_v_add79_high64 v_shr85 && true;
(*   %shr95 = lshr i128 %add89, 64 *)
(* You may need to modify here *)
split v_shr95 tmp_v_add89_low64 v_add89 64;
(*   %add99 = add nsw i128 %sub73, %shr95 *)
add v_add99 v_sub73 v_shr95;
(*   %conv101 = trunc i128 %add89 to i64 *)
split tmp_v_add89_high64 v_conv101 v_add89 64;
vpc v_conv101@uint64 v_conv101@uint128;
(* Heuristics applied. *)
assert true && eq uext v_conv101 64 tmp_v_add89_low64;
assume eq v_conv101 tmp_v_add89_low64 && true;
(* Heuristics applied. *)
assert true && eq tmp_v_add89_high64 v_shr95;
assume eq tmp_v_add89_high64 v_shr95 && true;
...
split tmp_v_add99_high64 v_conv114 v_add99 64;
vpc v_conv114@uint64 v_conv114@uint128;
(*modify*)
assert true && eq tmp_v_add99_high64 0@128;
assume eq tmp_v_add99_high64 0 && true;
