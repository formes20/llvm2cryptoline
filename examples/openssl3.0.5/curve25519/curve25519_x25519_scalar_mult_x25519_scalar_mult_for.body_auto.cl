proc fe51_mul (uint64 f_0, uint64 f_8, uint64 f_16, uint64 f_24, uint64 f_32, uint64 g_0, uint64 g_8, uint64 g_16, uint64 g_24, uint64 g_32) =
...
(* You may need to modify here *)
split v_shr73_i478 tmp_to_be_used v_add65_i470 51;
...
(* You may need to modify here *)
split v_shr79_i485 tmp_to_be_used v_add70_i475 51;
...
(* You may need to modify here *)
split v_shr84_i490 tmp_to_be_used v_add76_i482 51;
...
mov _ arraydecay11_0@uint64;
mov _ arraydecay14_0@uint64;
mov _ arraydecay24_0@uint64;
mov _ arraydecay27_0@uint64;
mov _ arrayidx12_i_0@uint64;
mov _ arrayidx12_i137_0@uint64;
mov _ arrayidx17_i_0@uint64;
mov _ arrayidx17_i142_0@uint64;
mov _ arrayidx1_i_0@uint64;
mov _ arrayidx1_i89_0@uint64;
mov _ arrayidx22_i125_0@uint64;
mov _ arrayidx22_i147_0@uint64;
mov _ arrayidx3_2_i103_0@uint64;
mov _ arrayidx3_3_i109_0@uint64;
mov _ arrayidx3_4_i115_0@uint64;
mov _ arrayidx7_i123_0@uint64;
mov _ arrayidx7_i132_0@uint64;
mov _ arrayidx_1_i96_0@uint64;
mov _ arrayidx_2_i_0@uint64;
mov _ arrayidx_2_i102_0@uint64;
mov _ arrayidx_3_i_0@uint64;
mov _ arrayidx_3_i108_0@uint64;
mov _ arrayidx_4_i_0@uint64;
mov _ arrayidx_4_i114_0@uint64;
mov _ v101@uint64;
mov _ v_add81_i487@uint64;
mov _ v_add87_i493@uint64;
mov _ v_and18@uint32;
mov _ v_conv17@uint32;
