...
split v_shr tmp_to_be_used v_add49 51;
...
split tmp_v_add49 v_conv66 v_add49 64;
...
(* You may need to modify here *)
split v_shr67 tmp_to_be_used v_add58 51;
...
split tmp_v_add58 v_conv71 v_add58 64;
...
vpc tmp_to_be_used@uint64 tmp_to_be_used@uint128;
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and72 tmp_to_be_used;
assume eq v_and72 tmp_to_be_used && true;
(*   %shr73 = lshr i128 %add65, 51 *)
(* You may need to modify here *)
split v_shr73 tmp_to_be_used v_add65 51;
...
split tmp_v_add65 v_conv77 v_add65 64;
...
vpc tmp_to_be_used@uint64 tmp_to_be_used@uint128;
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and78 tmp_to_be_used;
assume eq v_and78 tmp_to_be_used && true;
(*   %shr79 = lshr i128 %add70, 51 *)
(* You may need to modify here *)
split v_shr79 tmp_to_be_used v_add70 51;
(*   %conv80 = trunc i128 %shr79 to i64 *)
split tmp_v_shr79 v_conv80 v_shr79 64;
vpc v_conv80@uint64 v_conv80@uint128;
(*modify*)
assert true && eq tmp_v_shr79 0@128;
assume eq tmp_v_shr79 0 && true;
(*   %add81 = add i64 %and, %conv80 *)
add v_add81 v_and v_conv80;
(*   %conv82 = trunc i128 %add70 to i64 *)
split tmp_v_add70 v_conv82 v_add70 64;
...
vpc tmp_to_be_used@uint64 tmp_to_be_used@uint128;
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and83 tmp_to_be_used;
assume eq v_and83 tmp_to_be_used && true;
(*   %shr84 = lshr i128 %add76, 51 *)
(* You may need to modify here *)
split v_shr84 tmp_to_be_used v_add76 51;
(*   %conv85 = trunc i128 %shr84 to i64 *)
split tmp_v_shr84 v_conv85 v_shr84 64;
vpc v_conv85@uint64 v_conv85@uint128;
(*modify*)
assert true && eq tmp_v_shr84 0@128;
assume eq tmp_v_shr84 0 && true;
...
split tmp_v_add76 v_conv88 v_add76 64;
...
vpc tmp_to_be_used@uint64 tmp_to_be_used@uint128;
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and89 tmp_to_be_used;
assume eq v_and89 tmp_to_be_used && true;
(*   %shr90 = lshr i64 %add81, 51 *)
(* You may need to modify here *)
split v_shr90 tmp_to_be_used v_add81 51;
...
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and92 tmp_to_be_used;
assume eq v_and92 tmp_to_be_used && true;
(*   %shr93 = lshr i64 %add87, 51 *)
(* You may need to modify here *)
split v_shr93 tmp_to_be_used v_add87 51;
...
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and95 tmp_to_be_used;
assume eq v_and95 tmp_to_be_used && true;
...

{
	...
	((limbs  51  [f_0,f_8,f_16,f_24,f_32])	**	2)
	((limbs  255  [0,1])-19)
	&&
	true
}
