...
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and83_i489 tmp_to_be_used;
assume eq v_and83_i489 tmp_to_be_used && true;
...
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and78_i484 tmp_to_be_used;
assume eq v_and78_i484 tmp_to_be_used && true;
...
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and89_i495 tmp_to_be_used;
assume eq v_and89_i495 tmp_to_be_used && true;
