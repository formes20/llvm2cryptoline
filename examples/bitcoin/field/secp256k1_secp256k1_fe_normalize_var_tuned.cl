...
(*modify*)
subc flag dontcare v_or 1@uint64;
(*   br i1 %tobool, label %if.then, label %if.end *)

(* translate from if.then *)

(*   %37 = load i64, i64* %t0, align 8 *)
mov v37 t0_0;
(*   %add34 = add i64 %37, 4294968273 *)
add v_add34 v37 (4294968273)@uint64;
...
(* You may need to modify here *)
split v_shr35 tmp_to_be_used v38 52;
(*   %39 = load i64, i64* %t1, align 8 *)
mov v39 t1_0;
(*   %add36 = add i64 %39, %shr35 *)
add v_add36 v39 v_shr35;
...
(* You may need to modify here *)
and uint64 v_and37 v40 (0xFFFFFFFFFFFFF)@uint64;
(* Rule AND after LSHR Heuristics applied. *)
...
(* You may need to modify here *)
split v_shr38 tmp_to_be_used v41 52;
(*   %42 = load i64, i64* %t2, align 8 *)
mov v42 t2_0;
(*   %add39 = add i64 %42, %shr38 *)
add v_add39 v42 v_shr38;
...
(* You may need to modify here *)
and uint64 v_and40 v43 (0xFFFFFFFFFFFFF)@uint64;
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and40 tmp_to_be_used;
assume eq v_and40 tmp_to_be_used && true;
...
(* You may need to modify here *)
split v_shr41 tmp_to_be_used v44 52;
(*   %45 = load i64, i64* %t3, align 8 *)
mov v45 t3_0;
(*   %add42 = add i64 %45, %shr41 *)
add v_add42 v45 v_shr41;
...
(* You may need to modify here *)
and uint64 v_and43 v46 (0xFFFFFFFFFFFFF)@uint64;
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and43 tmp_to_be_used;
assume eq v_and43 tmp_to_be_used && true;
...
(* You may need to modify here *)
split v_shr44 tmp_to_be_used v47 52;
(*   %48 = load i64, i64* %t4, align 8 *)
mov v48 t4_0;
(*   %add45 = add i64 %48, %shr44 *)
add v_add45 v48 v_shr44;
...
(* You may need to modify here *)
and uint64 v_and46 v49 (0xFFFFFFFFFFFFF)@uint64;
(* Rule AND after LSHR Heuristics applied. *)
assert true && eq v_and46 tmp_to_be_used;
assume eq v_and46 tmp_to_be_used && true;
(*   store i64 %and46, i64* %t3, align 8 *)
mov t3_0 v_and46;
(*   br label %do.body47 *)


(* translate from do.end51 *)

(*   %52 = load i64, i64* %t4, align 8 *)
mov v52 t4_0;
(*   %and52 = and i64 %52, 281474976710655 *)
(* You may need to modify here *)
and uint64 v_and52 v52 (0xFFFFFFFFFFFF)@uint64;
(* Rule AND after LSHR Heuristics applied. *)
//assert true && eq v_and52 tmp_to_be_used;
//assume eq v_and52 tmp_to_be_used && true;
(*   store i64 %and52, i64* %t4, align 8 *)
mov t4_0 v_and52;
(*   br label %if.end *)

(* translate from if.end *)

(*   %53 = load i64, i64* %t0, align 8 *)
//mov v53 t0_0;
cmov v53 flag v_and37 v_and11;
