proc main (uint64 a_0, uint64 a_8, uint64 a_16, uint64 a_24, uint64 b_0, uint64 b_8, uint64 b_16, uint64 b_24, uint1 v_cmp13_i, uint1 v_cmp18_i, uint1 v_cmp25_i, uint1 v_cmp3_i, uint1 v_cmp8_i, uint1 v_cmp_i) =
{
	true
	&&
	true
...
mov b_16_init b_16;
mov b_24_init b_24;
mov v_cmp13_i_init v_cmp13_i;
mov v_cmp18_i_init v_cmp18_i;
mov v_cmp25_i_init v_cmp25_i;
mov v_cmp3_i_init v_cmp3_i;
mov v_cmp8_i_init v_cmp8_i;
...
split tmp_v_add_i v_conv_i54 v_add_i 64;
...
split v_shr_i tmp_to_be_used_add_i v_add_i 64;
(*modify*)
...
split tmp_v_add_i58 v_conv_i59 v_add_i58 64;
...
(* You may need to modify here *)
split v_shr_i60 tmp_to_be_used_add_i58 v_add_i58 64;
(*modify*)
assert true && eq v_shr_i60 tmp_v_add_i58;
assume eq v_shr_i60 tmp_v_add_i58 && true;
...
split tmp_v_add_i64 v_conv_i65 v_add_i64 64;
...
(* You may need to modify here *)
split v_shr_i66 tmp_to_be_used_add_i64 v_add_i64 64;
...
split tmp_v_add_i70 v_conv_i71 v_add_i70 64;
...
(* You may need to modify here *)
split v_shr_i72 tmp_to_be_used v_add_i70 64;
(*modify*)
assert true && eq v_shr_i72 tmp_v_add_i70;
assume eq v_shr_i72 tmp_v_add_i70 && true;
(*   %cmp.i = icmp ne i64 %conv.i71, -1 *)
(*modify*)
subb lt_v dontcare v_conv_i71 0xffffffffffffffff@uint64;
subb gt_v dontcare 0xffffffffffffffff@uint64 v_conv_i71;
...
(*modify*)
subb lt_v dontcare v_conv_i65 0xffffffffffffffff@uint64;
subb gt_v dontcare 0xffffffffffffffff@uint64 v_conv_i65;
or uint1 v_cmp8_i lt_v gt_v;
not uint1 v_cmp8_i v_cmp8_i;
...
split tmp_v_shr_i72 v8 v_shr_i72 32;
vpc v8@uint32 v8@uint128;
(*modify*)
assert true && eq tmp_v_shr_i72 0@128;
assume eq tmp_v_shr_i72 0 && true;
...
//assert true && eq v_conv_i_i v_add_i;
//assume eq v_conv_i_i v_add_i && true;
(*modify*)
assert true && eq v_conv_i_i tmp_to_be_used_add_i;
assume eq v_conv_i_i tmp_to_be_used_add_i && true;
...
split tmp_v_add_i_i v_conv_i38_i v_add_i_i 64;
...
(* You may need to modify here *)
split v_shr_i_i tmp_to_be_used v_add_i_i 64;
(*modify*)
assert true && eq v_shr_i_i tmp_v_add_i_i;
assume eq v_shr_i_i tmp_v_add_i_i && true;
(*   %conv.i39.i = and i128 %add.i58, 18446744073709551615 *)
(* You may need to modify here *)
and uint128 v_conv_i39_i v_add_i58 (0xFFFFFFFFFFFFFFFF)@uint128;
(* Heuristics get low 64 bit applied. *)
//assert true && eq v_conv_i39_i v_add_i58;
//assume eq v_conv_i39_i v_add_i58 && true;
(*modify*)
assert true && eq v_conv_i39_i tmp_to_be_used_add_i58;
assume eq v_conv_i39_i tmp_to_be_used_add_i58 && true;
...
split tmp_v_add_i42_i v_conv_i43_i v_add_i42_i 64;
...
(* You may need to modify here *)
split v_shr_i44_i tmp_to_be_used v_add_i42_i 64;
(*modify*)
assert true && eq v_shr_i44_i tmp_v_add_i42_i;
assume eq v_shr_i44_i tmp_v_add_i42_i && true;
(*   %conv.i45.i = and i128 %add.i64, 18446744073709551615 *)
(* You may need to modify here *)
and uint128 v_conv_i45_i v_add_i64 (0xFFFFFFFFFFFFFFFF)@uint128;
(*modify*)
assert true && eq v_conv_i45_i tmp_to_be_used_add_i64;
assume eq v_conv_i45_i tmp_to_be_used_add_i64 && true;
...
split tmp_v_add_i48_i v_conv_i49_i v_add_i48_i 64;
...
(* You may need to modify here *)
split v_shr_i50_i tmp_to_be_used v_add_i48_i 64;
(*modify*)
assert true && eq v_shr_i50_i tmp_v_add_i48_i;
assume eq v_shr_i50_i tmp_v_add_i48_i && true;
(*   %9 = trunc i128 %shr.i50.i to i64 *)
split tmp_v_shr_i50_i v9 v_shr_i50_i 64;
vpc v9@uint64 v9@uint128;


(*modify*)
assert true && eq tmp_v_shr_i50_i 0@128;
assume eq tmp_v_shr_i50_i 0 && true;
...

{
	...
	(limbs  64  [0xBFD25E8CD0364141,0xBAAEDCE6AF48A03B,0xFFFFFFFFFFFFFFFE,0xFFFFFFFFFFFFFFFF])
	&&
	true
}
