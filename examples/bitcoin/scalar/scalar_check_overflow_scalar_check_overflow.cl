proc main (uint64 a_0, uint64 a_8, uint64 a_16, uint64 a_24, uint1 v_cmp, uint1 v_cmp13, uint1 v_cmp18, uint1 v_cmp25, uint1 v_cmp3, uint1 v_cmp8) =
{
	true
	&&
	true
...
mov a_16_init a_16;
mov a_24_init a_24;
mov v_cmp_init v_cmp;
mov v_cmp13_init v_cmp13;
mov v_cmp18_init v_cmp18;
mov v_cmp25_init v_cmp25;
mov v_cmp3_init v_cmp3;
mov v_cmp8_init v_cmp8;
